...
export default function CreateAlertForm({ onClose }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      {/* Backdrop */}
      <div className="absolute inset-0 bg-ink-700/30 backdrop-blur-sm" onClick={onClose} />

      {/* Modal */}
      <div className="relative w-full max-w-lg gradient-border rounded-2xl bg-white p-6 animate-slide-up shadow-2xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          {/* Description */}
          <div>
            <label className="label">Description <span className="text-ink-500 normal-case font-normal">optional</span></label>
            <textarea
          ...
          <div className="flex gap-3 pt-1">
            ...
            <button type="submit" className="btn-primary flex-1 justify-center" disabled={createLoading || !title.trim()}>
              <Zap size={14} />
